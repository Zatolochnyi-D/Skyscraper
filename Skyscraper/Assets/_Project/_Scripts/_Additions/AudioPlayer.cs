...
namespace ThreeDent.DevelopmentTools.Option
{
    public class AudioPlayer : Singleton<AudioPlayer>
    {
        ...
        public void PlayDistant2d(AudioClip audio, Vector2 position, Option<Camera> camera, float localVolume = 1f)
        {
        ...
        public void PlayDistant2d(AudioClip audio, Vector2 position, float localVolume = 1f)
        {
            PlayDistant2d(audio, position, Option.None<Camera>());
        }
    }
}